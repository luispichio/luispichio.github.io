...
title: T.Wizard
description: >
    Aplicación de configuración para terminales Orbcomm IDP/ST<br>
    Twindimension<br>
    Q1/2023 - Actualidad
img: assets/projects/twizard/1.jpg
importance: 2
category: featured
...
- Diseño / especificación Técnicas.
    - Configuraciones, formularios, validaciones
- Desarrollo
    - Microservicios
        - Ingesta / mensajería bi-direccional
        - Configuración
        - Wizard's
    - Processing Service
...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/projects/twizard/1.jpg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/projects/twizard/2.jpg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
</swiper-container>
